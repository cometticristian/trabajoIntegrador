window.addEventListener("load", function () {
    ...
    productForm.addEventListener("submit", function (e) {
        ...
        else if(price.value.length < 1){document.querySelector("span.price").innerText = "Debe completar el precio"; e.preventDefault();}
        else if(discount.value.length < 1){document.querySelector("span.discount").innerText = "Debe completar el descuento aunque sea 0"; e.preventDefault();}            
        else if(
            document.querySelector("span.name").innerText ||
            document.querySelector("span.description").innerText
            ) {
